...
import TablePage from "../../../page-objects/tablePage"
...
describe("set", () => {
    ...
    it("Site", () => {
        ...
        cy.fixture('phones').then((object) => {
            ...
            CatalogPage.open();
            CatalogPage.loadLoginPage();
            LoginPage.performLogin();
            SearchPage.performSearch(phone.shortName);
            TablePage.findProductInTable(phone.shortName);
            ProductPage.performBuy();
            ShoppingCartPage.changeQuantityOfGoods(phone);
